...
#include <iostream>
#include <random>
RandomAI::RandomAI(int PlayerOrder, BlankBoard &InitialBoard) {
...
void RandomAI::SetPlacementBoardAndFiringBoard(BlankBoard &InitialBoard) {
...
void RandomAI::PrintOutPlacementBoard() {
...
void RandomAI::PrintOutFiringBoard() {
...
std::vector<std::pair<int, int>> RandomAI::GetVectorOfSelfValidCoordinates() {
...
std::vector<std::pair<int, int>> RandomAI::GenerateOrGetRandomShootList() {
...
std::string RandomAI::GetName() {
    return this->Player_Name;
}

std::vector<std::vector<std::string>> RandomAI::GetSelfBoard() {
    return this->Self_Board;
}

std::vector<std::vector<std::string>> RandomAI::GetOpponentFireBoard() {
